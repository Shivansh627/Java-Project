...
public class BlackJack {
    private class Card{
        ...
        public String getIagePath(){
            return "./cards/"+toString()+".png";
        }
    }

    ArrayList<Card> deck;
    Random random =new Random();//suffle deck
        ...
        public void paintComponent(Graphics g){
            ...
            try{
                ...
                if(!stayButton.isEnabled()){
                    hiddenCardImage = new ImageIcon(getClass().getResource(hiddenCard.getIagePath())).getImage();
                }
                ...
                for(int i=0;i<dealerHand.size();i++){
                    ...
                    Image cardImg =new ImageIcon(getClass().getResource(card.getIagePath())).getImage();
